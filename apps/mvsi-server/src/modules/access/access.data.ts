  ...
  profile: {
    ...
    inventory: {
      ...
      character_BananaGuard: {
        count: 1,
        created_at: { _hydra_unix_date: 1717623131 },
      },
      character_Jason: {
        count: 1,
        created_at: { _hydra_unix_date: 1719953609 },
      },
      character_c024: {
        count: 1,
        created_at: { _hydra_unix_date: 1724516313 },
      },
      character_currency: { count: 18000, created_at: null },
      character_wonder_woman: {
        count: 1,
        created_at: { _hydra_unix_date: 1731440307 },
      },
      "battlepass-season-1": {
        count: 1,
        created_at: { _hydra_unix_date: 1717084202 },
      },
      character_batman: {
        count: 1,
        created_at: { _hydra_unix_date: 1731688838 },
      },
      character_bugs_bunny: {
        count: 1,
        created_at: { _hydra_unix_date: 1731688851 },
      },
      character_tom_and_jerry: {
        count: 1,
        created_at: { _hydra_unix_date: 1732575663 },
      },
      character_jake: {
        count: 1,
        created_at: { _hydra_unix_date: 1732575668 },
      },
      character_garnet: {
        count: 1,
        created_at: { _hydra_unix_date: 1732575671 },
      },
      character_finn: {
        count: 1,
        created_at: { _hydra_unix_date: 1733457837 },
      },
      skin_c034_s01: {
        count: 1,
        created_at: { _hydra_unix_date: 1720213546 },
      },
      character_superman: {
        count: 1,
        created_at: { _hydra_unix_date: 1736045527 },
      },
      character_c019: {
        count: 1,
        created_at: { _hydra_unix_date: 1736045545 },
      },
      character_c16: {
        count: 1,
        created_at: { _hydra_unix_date: 1737516767 },
      },
      character_steven: {
        count: 1,
        created_at: { _hydra_unix_date: 1738278768 },
      },
      character_C029: {
        count: 1,
        created_at: { _hydra_unix_date: 1738983257 },
      },
      character_C020: {
        count: 1,
        created_at: { _hydra_unix_date: 1741621929 },
      },
      character_c038: {
        count: 1,
        created_at: { _hydra_unix_date: 1741622129 },
      },
    },
    matches: {
