...
export async function handleAccess(
  ...
  let accountDoc = account.toJSON<AccountDoc>();
  ...
  const response: MVSResponses.Access_RESPONSE = {
    // TODO access token
    token:
      "V2wvUvGjnf0Ma23VCEJXFZHDPewZ8FdaYjXGvpqsdzxMHk9BvyPLMTymAOM6WDqWPkGOXMYAPcSKAjZRiEh79EOpzsk9pVW5zj/0bxOaYgMXPCe4opBb2LY7twuGq4cHh4B7uer44UVxHP/VjzQbHGqEa8BzzdjMrZn3rPGl0H5S9sOkokqiEw==",
    in_queue: false,
    configuration: {
      gcm: {
        enabled: null,
