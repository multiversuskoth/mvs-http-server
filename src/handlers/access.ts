...
function generateStaticAccess(steamId: string) {
  const account: Account = {
    id: ObjectID().toHexString(),
    profile_id: ObjectID().toHexString(),
    public_id: ObjectID().toHexString(),
    wb_network_id: ObjectID().toHexString(),
    username: USERNAME(),
  };
  ...
  return {
    ...
    account: {
      ...
      identity: {
        ...
        personal_data: {},
        alternate: {
          wb_network: [{ id: account.wb_network_id, username: USERNAME(), avatar: null, email: null }],
          steam: [
            {
        ...
        usernames: [
          ...
          { auth: "steam", username: USERNAME() },
          { auth: "wb_network", username: USERNAME() },
        ],
        platforms: ["steam"],
  ...
  res.send({
    ...
    account: {
      ...
      identity: {
        ...
        personal_data: {},
        alternate: {
          wb_network: [{ id: "pafd8d7950aa1484ea791d06662fa75ce", username: USERNAME(), avatar: null, email: null }],
          steam: [
            {
              id: "76561195177950873",
              username: "multiversuskoth",
      ...
      email_verification: { state: "unverified" },
      opt_ins: { wbplay_optin: false },
      auth: { wb_network: [{ id: "pafd8d7950aa1484ea791d06662fa75ce", created_at: { _hydra_unix_date: 1674508668 } }] },
      wb_account: { completed: true, age_category: "adult", email_verified: false },
      external_accounts: {},
      privacy_levels: {
        presence: { state: "default" },
